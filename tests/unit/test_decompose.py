...
# The decomposer's tunables live in the distrule table at runtime; here they're the subset of
# migration 0129's seed rules needed by these layout cases. Adding a case that needs a new
# bucket or remap means adding it here too
