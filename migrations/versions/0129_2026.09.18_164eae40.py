...
Revision ID: 0129_2026.09.18_164eae40
Revises: 0128_2026.09.17_33db6ec7
Create Date: 2026-09-18 13:16:26.508216+00:00
"""
...
revision: str = "0129_2026.09.18_164eae40"
down_revision: str | None = "0128_2026.09.17_33db6ec7"
branch_labels: str | abc.Sequence[str] | None = None
depends_on: str | abc.Sequence[str] | None = None

_KIND_ENUM = sqlalchemy.Enum(
    "project_remap",
    "grouping_bucket",
    "committee_bucket",
    "excluded_part",
...
# Each carries the reasoning that was an inline comment in the note column. committee scopes
# project remaps and committee buckets; pattern holds the matched token for the membership-set
# kinds; a project remap matches committee/subproject and rewrites to target
_SEED: list[dict[str, object]] = [
    ...
    },
    {
        "kind": "project_remap",
        "committee": "aries",
        "subproject": "javax.persistence",
        "target": "aries-javax-persistence",
    },
    {"kind": "project_remap", "committee": "felix", "subproject": "javax.servlet", "target": "felix-javax-servlet"},
    {
        "kind": "project_remap",
        "committee": "felix",
        "subproject": "org.osgi.compendium",
        "target": "felix-org-osgi-compendium",
    },
    {"kind": "project_remap", "committee": "felix", "subproject": "org.osgi.core", "target": "felix-org-osgi-core"},
    {
        "kind": "project_remap",
        "committee": "felix",
        "subproject": "org.osgi.foundation",
        "target": "felix-org-osgi-foundation",
    },
    {
        "kind": "project_remap",
        "committee": "felix",
        "subproject": "org.osgi.service.obr",
        "target": "felix-org-osgi-service-obr",
    },
    {"kind": "project_remap", "committee": "felix", "subproject": "osgi.core", "target": "felix-osgi-core"},
    {"kind": "project_remap", "committee": "felix", "subproject": "shell.tui", "target": "felix-shell-tui"},
    {"kind": "project_remap", "committee": "incubator", "subproject": "lucene.net", "target": "lucenenet"},
    {"kind": "project_remap", "committee": "lucenenet", "subproject": "Apache-Lucene.Net", "target": "lucenenet"},
    {
        "kind": "project_remap",
        "committee": "sling",
        "subproject": "sling-maven-plugin.parent",
        "target": "sling-maven-plugin",
    },
    {"kind": "project_remap", "committee": "tapestry", "subproject": "Tapestry-Web", "target": "tapestry"},
...
def upgrade() -> None:
    op.create_table(
        "distrule",
        sqlalchemy.Column("id", sqlalchemy.Integer(), autoincrement=True, nullable=False),
        sqlalchemy.Column("kind", _KIND_ENUM, nullable=False),
        sqlalchemy.Column("committee", sqlalchemy.String(), nullable=True),
        sqlalchemy.Column("subproject", sqlalchemy.String(), nullable=True),
        sqlalchemy.Column("pattern", sqlalchemy.String(), nullable=True),
        sqlalchemy.Column("target", sqlalchemy.String(), nullable=True),
        sqlalchemy.Column("enabled", sqlalchemy.Boolean(), nullable=False),
        sqlalchemy.Column("note", sqlalchemy.String(), nullable=True),
        sqlalchemy.PrimaryKeyConstraint("id", name=op.f("pk_distrule")),
    )
    op.create_index(op.f("ix_distrule_kind"), "distrule", ["kind"], unique=False)

    seed_table = sqlalchemy.table(
        "distrule",
        sqlalchemy.column("kind", sqlalchemy.String()),
        sqlalchemy.column("committee", sqlalchemy.String()),
        sqlalchemy.column("subproject", sqlalchemy.String()),
